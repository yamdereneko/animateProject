...
let images = [
    ["image":"ios11-animations","text":"香销冷雨帘襟落，提阶上，空廊回风，忆艾郎，前日曾共沐，暖手同游，梦惊尤在枕边，孤影叹单，冷暖心知"],
    ["image":"ios11-colors","text":"星宿如许笑苍茫，泪成行，咬噬忧郁的泪滴，诉说心扉，风影传音，仿佛你的呢喃在耳边萦绕"],
    ["image":"ios11-icons","text":"无人解，千年相思，摆一方案几，煮一壶清酒，你依然独自守着一份属于自己的城池"],
    ["image":"ios11-inspiration","text":"相遇，总是显得悄然而又美丽，但擦肩过后，心痛却又呼啸着占满整个世纪，试图用它独特的暖意去磨灭伤痕的印记"],
    ["image":"ios11-ipad","text":"细雨梦回，小楼吹彻玉笙寒。我的目光，湿在幽深雨巷边。当年你一去无回，别离的愁绪万千，纵使相知成陌路，我依然为你植下相思的玫瑰园"],
    ["image":"ios11-iphone-x","text":"奈何，清醒最是夜深处!晚风未落，残柳参差舞。流水飞花似梦，丛山落雪无痕。回首悠悠往事，聚散有谁能定"],
    ["image":"ios11-cover","text":"余阳铺路，枫叶漫舞。艳红的枫，伴着优雅的舞姿，携着丝丝沉郁绵绵的情意，回旋在那低矮的天幕，历经万千，风雨不化"]
]
let fruit = [
    ["image":"meishi_bingjiling","text":"冰淇淋"],
    ["image":"meishi_caomei","text":"草莓"],
    ["image":"meishi_chengzi","text":"橙子"],
    ["image":"meishi_hanbao","text":"汉堡"],
    ["image":"meishi_hetao","text":"核桃"],
    ["image":"meishi_kaixinguo","text":"开心果"],
    ["image":"meishi_li","text":"梨子"],
    ["image":"meishi_mangguo","text":"芒果"],
    ["image":"meishi_manyuemei","text":"蔓越莓"],
    ["image":"meishi_niunai","text":"牛奶"],
    ["image":"meishi_niuyouguo","text":"牛油果"],
    ["image":"meishi_pisa","text":"披萨"],
    ["image":"meishi_songzi","text":"松子"],
    ["image":"meishi_tiantianquan","text":"甜甜圈"],
